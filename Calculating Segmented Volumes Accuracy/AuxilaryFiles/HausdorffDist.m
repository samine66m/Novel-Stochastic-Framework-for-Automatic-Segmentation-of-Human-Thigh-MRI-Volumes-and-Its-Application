...
if nargin==4 && any(strcmpi({'v','vis','visual','visualize','visualization'},dv))
    ...
    if largeMat == 1 || sP(2)>3
        ...
        warning('MATLAB:actionNotTaken Visualization failed because data sets were too large or data dimensionality > 3.')
    ...
    rectangle('position',[ixhd(1)-0.5 ixhd(2)-0.5 1 1],'edgecolor','w','linewidth',2);
